export function getPanelCopy(language: string) {
  ...
  const base = {
    ...
    incompleteBehaviorTreeRename: "The webview sent an incomplete BehaviorTree rename request.",
    behaviorTreeRenameUnchanged: "BehaviorTree name already matches the current XML.",
    behaviorTreeRenamed: "BehaviorTree renamed.",
    behaviorTreeRenameFailed: "Failed to rename BehaviorTree.",
    ...
    clearImportedNodesConfirm: "Clear imported node definitions? Bundled default nodes will stay unchanged.",
    clearImportedNodesAction: "Clear",
    clearImportedNodesCanceledAction: "Cancel",
    importedNodesCleared: "Imported node definitions were cleared.",
  ...
  return {
    ...
    incompleteBehaviorTreeRename: "Webview 发送的 BehaviorTree 重命名请求不完整。",
    behaviorTreeRenameUnchanged: "BehaviorTree 名称与当前 XML 已一致。",
    behaviorTreeRenamed: "BehaviorTree 已重命名。",
    behaviorTreeRenameFailed: "重命名 BehaviorTree 失败。",
    ...
    clearImportedNodesConfirm: "清除已导入的节点定义？内置默认节点不会被修改。",
    clearImportedNodesAction: "清除",
    clearImportedNodesCanceledAction: "取消",
    importedNodesCleared: "已清除导入的节点定义。",
