(function () {
  ...
  function getPlaybackCopy(language = getCurrentLanguage()) {
    const base = {
      ...
      traceConfigTitle: "Configure Trace",
      traceConfigDescription: "Trace uses API providers only. Add a custom provider or edit the local config file.",
      traceConfigLoading: "Loading Trace config...",
      ...
      traceEmpty: "Ask Trace to investigate the current btlog frame.",
      traceQuestion: "You",
      traceAnswer: "Trace",
      traceRequestCancelled: "Trace request cancelled.",
    ...
    return localize(
      base,
      {
        ...
        traceConfigTitle: "配置塔斯",
        traceConfigDescription: "塔斯只通过 API 调用服务商。添加自定义服务或编辑本地配置文件即可。",
        traceConfigLoading: "正在读取塔斯配置...",
        ...
        traceCurrentProvider: (provider, model) => `${provider} · ${model}`,
        traceEmpty: "向塔斯提问，排查当前 btlog 帧。",
        traceQuestion: "你",
        traceAnswer: "塔斯",
        traceRequestCancelled: "塔斯请求已取消。",
